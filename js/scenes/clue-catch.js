...
function goExplore() {
  ...
  sty.textContent = '@keyframes caveIn{from{opacity:0;transform:scale(.93)}to{opacity:1;transform:scale(1)}}@keyframes caveInTxt{from{opacity:0}to{opacity:1}}';
  document.head.appendChild(sty);

  setTimeout(function() {
    overlay.remove(); sty.remove();
